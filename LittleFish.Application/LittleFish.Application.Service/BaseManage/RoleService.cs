...
using LittleFish.Application.Service.AuthorizeManage;
using LittleFish.Application.IService.AuthorizeManage;

namespace LittleFish.Application.Service.BaseManage
{
    /// <summary>
    /// 版 本
