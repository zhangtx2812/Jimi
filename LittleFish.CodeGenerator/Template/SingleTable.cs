using LittleFish.CodeGenerator.Comm;
...
namespace LittleFish.CodeGenerator.Template
{
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("namespace LittleFish.Application.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using LittleFish.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace LittleFish.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 小鱼科技有限公司\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using LittleFish.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using LittleFish.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using LittleFish.Data.Repository;\r\n");
            sb.Append("using LittleFish.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n\r\n");

            sb.Append("namespace LittleFish.Application.Service." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 小鱼科技有限公司\r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace LittleFish.Application.IService." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 小鱼科技有限公司\r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using LittleFish.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using LittleFish.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using LittleFish.Application.Service." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using LittleFish.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace LittleFish.Application.Busines." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 小鱼科技有限公司\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using LittleFish.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using LittleFish.Application.Busines." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using LittleFish.Util;\r\n");
            sb.Append("using LittleFish.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace LittleFish.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 小鱼科技有限公司\r\n");
